...
set_property PACKAGE_PIN R16 [get_ports {ad_data[0]}]
set_property PACKAGE_PIN V18 [get_ports {ad_data[1]}]
set_property PACKAGE_PIN V19 [get_ports {ad_data[2]}]
set_property PACKAGE_PIN P19 [get_ports {ad_data[3]}]
set_property PACKAGE_PIN R17 [get_ports {ad_data[4]}]
set_property PACKAGE_PIN N17 [get_ports {ad_data[5]}]
set_property PACKAGE_PIN P17 [get_ports {ad_data[6]}]
